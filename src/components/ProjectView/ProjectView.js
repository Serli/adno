...
import { faDownload, faMagnifyingGlass, faMapMarked, faPenToSquare, faTrash } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            ...
                            <p className="card-text"><small className="text-muted"> <span className="label-nb-annos">{this.props.project.journeys ? this.props.project.journeys.length : 0}</span>  parcours {this.props.project.journeys && this.props.project.journeys.length > 1 ? "disponibles" : "disponible" } </small></p>
                            ...
                            <div className="buttons-group-proj-view">
                                ...
                                <button type="button" className="btn btn-primary btn-sm" onClick={() => this.props.history.push(`/${this.props.project.id}/journeys`)}> <FontAwesomeIcon icon={faMapMarked} />  Parcours  </button>
