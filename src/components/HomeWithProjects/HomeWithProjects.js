                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        JSON.parse(localStorage.getItem("adno_projects")).forEach(project => {
                            ...
                            var selected_project = JSON.parse(localStorage.getItem(project))

                            console.log(selected_project)

                            // remove all journeys linked to the current project
                            selected_project.journeys && selected_project.journeys.forEach(journey => localStorage.removeItem(journey))

                            // finally remove the current project in the loop
