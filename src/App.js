...
import NewJourney from "./components/Journeys/NewJourney/NewJourney";
            ...
            <div>
                <HashRouter history={history}>
                    ...
                    <Switch>
                        ...
                        <Route exact path="/:id_project/journeys">
                            <Journeys />
                        </Route>

                        <Route exact path="/:id_project/journeys/:id_journey">
                            <Viewer />
                        </Route>

                        <Route exact path="/:id_project/journeys/:id_journey/edit">
                            <Editor />
                        </Route>
