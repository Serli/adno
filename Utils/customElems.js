import { buildAudioPlayer, buildYoutubeEmbed, buildImage, buildVideoPlayer } from "./utils";
...
customElements.define('adno-audio', AdnoAudioPlayer);



class AdnoVideoPlayer extends HTMLElement {
    constructor() {
        super();
    }
    ...
    connectedCallback() {
        ...
        shadow.appendChild(wrapper);
        wrapper.appendChild(buildVideoPlayer(this.getAttribute('url')));

    }
}

customElements.define('adno-video', AdnoVideoPlayer);
